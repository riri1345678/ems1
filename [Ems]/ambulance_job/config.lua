...
Config.EarlyRespawnTimer          = 6000 * 5  -- time til respawn is available
Config.BleedoutTimer              = 6000 * 5 -- time til the player bleeds out
...
Cloak = {
    ...
    vehicles = {
        car = {
            ...
            {model = "ghispo3", label = "La voiture qui va vite", minimum_grade = 2}
        },
    },
    helico = {
        car = {
            {category = "↓ ~b~Véhicules Normaux ~s~↓"},
            {model = "Volatus", label = "Helicoptère", minimum_grade = 2}
        },
    }
}